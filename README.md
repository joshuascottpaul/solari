...
Vanilla HTML, CSS, and JavaScript. No framework, no build step, no API keys. Total size: approximately 145-149 KB (including JetBrains Mono 300 webfont added in Phase 17). Deployed as static files via GitHub Pages.
